...
const HeroSection = () => {
  return (
    <section className="relative w-full h-screen flex items-center justify-center bg-white text-[#333333] overflow-hidden">
      {/* Background Image */}
      <img
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button className="rounded-full bg-[#FFC107] hover:bg-black text-black hover:text-[#FFC107] font-semibold px-10 py-3 shadow-lg transition-all duration-300 hover:scale-105">
            Get Started →
          </button>

          <button className="font-semibold rounded-full border bg-black border-white text-white px-8 py-3 hover:bg-white hover:text-black  transition-all duration-300 hover:scale-105">
            View Demo
          </button>
