...
const Dashboard = () => {
  ...
  React.useEffect(() => {
    ...
    if (['dashboard', 'analytics', 'alerts'].includes(tab)) {
      setActiveTab(tab);
    }
  }, [searchParams]);
  ...
  return (
    <Layout>
      <div className="p-8 max-w-7xl mx-auto space-y-8">
        ...
        {/* Tab Navigation */}
        <div className="sticky top-16 z-30 bg-slate-50/95 dark:bg-slate-950/95 backdrop-blur py-3 -mx-2 px-2">
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-1 flex gap-1 shadow-sm">
          <button
